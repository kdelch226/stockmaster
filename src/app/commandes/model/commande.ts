...
export class Commande {
    ...
    private _produitIds: CommandeItem[];
    ...
    constructor(id: string, dateCommande: Date, dateLivraison: Date,dateUpdate: Date,_produitIds: CommandeItem[],prixCommande:number, clientName: string, lieu:string,statut: string) {
      this._id = id;
    ...
    get produitIds(): CommandeItem[] {
      return this._produitIds;
    }
  
    set produitIds(value: CommandeItem[]) {
